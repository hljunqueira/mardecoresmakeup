...
import { Plus, Edit, Trash2, Layers, Star } from "lucide-react";
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Gerencie suas coleções de produtos
              </p>
            </div>
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Produtos na Coleção</FormLabel>
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between text-sm text-muted-foreground">
                        <span>
                          {getProductsInCollection(collection.products || []).length} produtos
                        </span>
          ...
          {collections?.length === 0 && !isLoading && (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                Comece criando sua primeira coleção de produtos.
              </p>
            </div>
          )}
        </div>
